...
// INFO BOXES
// ==========================================================================
// SCROLL-DRIVEN VIEWPORT REVEAL LOGIC
// ==========================================================================
...
// ==========================================================================
// HERO SLIDER & SLIDESHOW TEXT ROTATION ENGINE
// ==========================================================================
document.addEventListener("DOMContentLoaded", () => {
    ...
    subtitle: "We leverage robust Microsoft security frameworks, advanced encryption, and zero-trust data protection to safeguard your enterprise assets."
}
       
    ];

    let currentSlideIndex = 0;
    const changeIntervalDuration = 4000; // Adjust image swap speed (4000 = 4 seconds)
